...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <audio
        ref={audioRef}
        src="https://p.scdn.co/mp3-preview/8b1e5e9c9c9c9c9c9c9c9c9c9c9c9c9c9c9c9c9c"
        preload="metadata"
      />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-br from-orange-200/40 to-amber-200/40 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-br from-amber-300/40 to-orange-300/40 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-stone-200/30 to-amber-200/30 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-screen">
          ...
          <div className="space-y-8 animate-fadeIn order-2 lg:order-1">
            ...
            <div className="space-y-4">
              <p className="text-xl text-stone-700 leading-relaxed max-w-lg font-light">
                A vibrant Afrobeat artist weaving magic through soulful
                melodies, celebrating love, culture, and the beautiful rhythms
                of life.
              </p>
              ...
              <div className="flex items-center space-x-2 text-stone-600">
                ...
                <span className="text-sm">
                  16+ years of musical storytelling
                </span>
              </div>
            </div>
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="relative group">
              ...
              <div
                className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-orange-600 to-amber-700 rounded-2xl flex items-center justify-center shadow-lg transform -rotate-12 hover:-rotate-6 transition-transform duration-500 animate-pulse"
                style={{ animationDelay: "1s" }}
              >
                <Heart className="w-10 h-10 text-stone-50" />
              </div>
              ...
              <div
                className="absolute bottom-1/4 -left-12 w-12 h-12 bg-stone-50/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg border border-amber-200/50 animate-bounce"
                style={{ animationDelay: "1s" }}
              >
                <span className="text-xl text-amber-700">♫</span>
              </div>
        ...
        <div className="hidden lg:block absolute bottom-20 left-1/2 transform -translate-x-1/2">
          <div className="flex items-center space-x-8">
            {[
              ...
              <div
                key={idx}
                className={`bg-gradient-to-r ${stat.color} rounded-full px-6 py-3 shadow-lg text-stone-50 text-center min-w-[120px]`}
              >
                <div className="font-bold text-lg">{stat.number}</div>
                <div className="text-xs opacity-90">{stat.label}</div>
              </div>
